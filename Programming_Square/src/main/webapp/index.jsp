...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="sign_in.jsp"> Login</a>
                </li>
                <li class="nav-item">
  ...
  <div class="card-container">
      ...
      <div class="card">
        ...
        <a href="sign_up.jsp" class="card-link">https://www.javatpoint.com/java-tutorial</a>
      </div>
      <div class="card">
        <h2 class="card-title">Best resource of design patterns in java</h2>
        <a href="sign_up.jsp" class="card-link">https://www.javatpoint.com/design-patterns-in-java</a>
      </div>
      <div class="card">
        <h2 class="card-title">video of java</h2>
        <a href="sign_up.jsp" class="card-link">https://www.youtube.com/watch?v=3OrEsC-QjUA</a>
      </div>
      <div class="card">
        <h2 class="card-title">MVC vs MVVM</h2>
        <a href="sign_up.jsp" class="card-link">https://www.guru99.com/mvc-vs-mvvm.html</a>
      </div>
      <div class="card">
        <h2 class="card-title">docker</h2>
        <a href="sign_up.jsp" class="card-link">https://www.youtube.com/watch?v=GUfKj6Eb-qY</a>
      </div>
    </div>
  <!-- end how section -->
